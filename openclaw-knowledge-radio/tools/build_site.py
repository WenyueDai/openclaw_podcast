...
<div class="layout">
  <div class="main-col">
    ...
    <div class="about">
      ...
      <p>Papers are ranked by journal quality, topic relevance, and the owner's personal reading history. The podcast is regenerated fresh each day and published here automatically via GitHub Actions.</p>
